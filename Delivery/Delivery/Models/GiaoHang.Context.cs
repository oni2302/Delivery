...
public partial class GiaoHangEntities : DbContext
{
    ...
    public virtual ObjectResult<TaiKhoan_ChiTiet_Result> TaiKhoan_ChiTiet(Nullable<int> manv)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<TaiKhoan_ChiTiet_Result>("TaiKhoan_ChiTiet", manvParameter);
    }


    public virtual ObjectResult<Nullable<int>> TaiKhoan_Xoa(Nullable<int> maNhanVien)
    {
        ...
        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("TaiKhoan_Xoa", maNhanVienParameter);
    }


    public virtual ObjectResult<TaiKhoan_DanhSach1_Result> TaiKhoan_DanhSach1()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<TaiKhoan_DanhSach1_Result>("TaiKhoan_DanhSach1");
    }
